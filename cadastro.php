        ...
        <div class="login-box">
            ...
            <form id="cadastroForm" action="./auxi/auxcadastro.php" method="POST">
                ...
                <div class="input-group password-group">
                    ...
                    <input type="password" id="senha" name="senha" value="" <?= isset($id_alterar) ? '' : '' ?> required>
                    <button type="button" id="mostrarSenha"></button>
                </div>
                <div class="input-group password-group">
                    <label for="confirmSenha">Confirme a Senha:</label>
                    <input type="password" id="confirmSenha" name="confirmSenha" value="" <?= isset($id_alterar) ? '' : '' ?> required>
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="CEP" name="CEP" placeholder="00000-000" value="<?= isset($dadosUsuario['CEP']) ? htmlspecialchars($dadosUsuario['CEP']) : '' ?>" required>
                </div>
                <div class="input-group">
